...
/// @title DeployHolesky
/// @notice Deployment script for Holesky Testnet
contract DeployHolesky is Script {
    AccessRegistry public accessRegistry;
    DistractionRecorder public distractionRecorder;

    function run() external {
        // Load Holesky private key
        uint256 deployerPrivateKey = vm.envUint("PRIVATE_KEY_HOLESKY");
        ...
        // Summary
        console.log("\n========================================");
        console.log("HOLESKY DEPLOYMENT COMPLETE");
        console.log("========================================");
        ...
        console.log(
            "export ACCESS_REGISTRY_HOLESKY=",
            vm.toString(address(accessRegistry))
        );
        console.log(
            "export DISTRACTION_RECORDER_HOLESKY=",
